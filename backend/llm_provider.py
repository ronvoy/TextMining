...
class LLMBackend:
    ...
    OpenRouter notes:
      ...
      - `llm_model_name` should be in format: provider/model
    ...
    def _build_openrouter_chat(self) -> BaseChatModel:
        ...
        return ChatOpenAI(
            ...
            default_headers={
                "HTTP-Referer": "https://legal-rag-chatbot.local",  # Optional: for OpenRouter analytics
                "X-Title": "Legal RAG Chatbot"  # Optional: for OpenRouter analytics
            }
        )
